...
values
    ...
    (1, 'The Checklist Manifesto', 'Atul Gawande 2010 memoir self-help surgeon', 3, true),
    (1, 'The Language of Baklava', 'Diana Abu-Jaber 2005 memoir Jordan Arab-American', 4, true),
    (1, 'Plowing the Dark', 'Richard Powers 2002 sci-fi virtual reality fiction', 5, true),
    ...
    (1, 'Walking the Gobi', 'Helen Thayer 2007 memoir desert nomad', 13, true),
    (1, 'Dearest Friend: A Life of Abigail Adams', 'Lynne Withey American History 2002 President biography', 14, true),
    (1, 'The Confessions of Nat Turner', 'William Styron 1992 fiction American History race slavery', 15, true),
    (1, 'The Passage', 'Justin Cronin 2010 vampire apocalyptic fiction', 16, true),
    (1, 'The Professor and the Madman', 'Simon Winchester 2004 Oxford English Dictionary history', 17, true),
    (1, 'Wool', 'Hugh Howey 2012 fiction apocalyptic sci-fi', 18, true),
    (1, 'To Kill a Mockingbird', 'Harper Lee 1960 fiction american history racism law southern', 19, true),
    (1, 'A Smarter Way to Learn Python', 'Mark Myers 2016 programming coding computer language', 20, true),
    (1, 'Two Wheels & a Taxi', 'Virginai Urrutia 1987 memoir Andes Ecuador bicycle travel', 21, true),
    (1, 'Rosiebelle Lee Wildcat Tennessee', 'Raymond Andrews Benny 1988 american southern fiction', 22, true),
    (1, 'Goldie Vance', 'Hope Larson Brittney Williams Sarah Stern 2016 graphic novel', 23, true),
    (1, 'Black Widow: Homecoming', 'Richard Morgan Bill Sienkiewicz 2005 graphic novel natasha romanov', 24, true),
    (1, 'Leaving Mother Lake', 'Yang Erche Namu Christine Mathieu 2004 China memoir', 25, true),
    (1, 'Lockdown', 'Laurie King 2017 mystery california school shooting', 26, true),
    (1, 'Nightingale Wood', 'Stella Gibbons fiction english 1920s flapper', 27, true),
    (1, 'My Own Miraculous', 'Joshilyn Jackson 2013 southern georgia fiction family', 28, true),
    (1, 'Genius: The Game', 'Leopoldo Gout 2016 YA sci-fi fiction adventure', 29, true),
    (1, 'The Arrivals', 'Melissa Marr 2013 sci-fi alternate fiction western', 30, true);
